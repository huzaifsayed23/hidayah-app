    ...
    try {
      if (targetUser) {
        ...
        if (profileRes.ok) {
          ...
          // Important: Keep hidayah_user in sync so interactions like Save/Unsave work
          safeStorage.setItem('hidayah_user', JSON.stringify(profileData.user));
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-6">
                    {displayPosts.map((post: any) => (
                      <FeedCard 
                        ...
                        currentUserName={loggedInUser?.username || loggedInUser?.user?.username}
